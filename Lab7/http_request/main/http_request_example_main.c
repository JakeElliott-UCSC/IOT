...
#define WEATHER_GET_PATH "/weather"
...
static const char *REQUEST_WEATHER_GET = "GET " WEATHER_GET_PATH " HTTP/1.0\r\n"
    "Host: " WEB_SERVER "\r\n"
    "User-Agent: esp-idf/1.0 esp32\r\n"
    "\r\n";
...
void get_weather(void)
{
    ...
    if (write(s, REQUEST_WEATHER_GET, strlen(REQUEST_WEATHER_GET)) < 0) {
        close(s);
        return;
    }
